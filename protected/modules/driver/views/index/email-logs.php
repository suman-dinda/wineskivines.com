...
<div class="parent-wrapper task-list-area">
 ...
 <div class="content_main">
   ...
   <div class="nav_option">
      <div class="row">
        <div class="col-md-6 border">
         <b><?php echo Driver::t("Email Logs")?></b>
        </div> <!--col-->
   ...
   <?php echo CHtml::hiddenField('action','EmailLogs')?>
   <table id="table_list" class="table table-hover">
   <thead>
    <tr>
      <th width="10%"><?php echo Driver::t("ID")?></th>      
      <th><?php echo Driver::t("Sender")?></th>
      <th><?php echo Driver::t("To")?></th>
      <th><?php echo Driver::t("Subject")?></th>
      <th><?php echo Driver::t("Content")?></th>      
