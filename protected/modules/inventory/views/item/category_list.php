...
<div class="card card_medium" id="box_wrap">
	...
	<div class="col-lg-7 col-sm-7"  >
	    ...
	    <a href="<?php echo Yii::app()->createUrl(APP_FOLDER.'/item/category_add/');?>" class="<?php echo ItemHtmlWrapper::newBtnClass()?>">
	    <i class="fas fa-plus"></i> <?php echo translate("ADD CATEGORY")?>
	    </a>   
	    ...
	    <div class="action_top_mobile">	    
		  ...
		  <div class="dropdown-menu dropdown-menu-left" >
			<a class="dropdown-item" href="<?php echo Yii::app()->createUrl(APP_FOLDER.'/item/category_add/');?>"><?php echo translate("ADD CATEGORY")?></a>		    
    ...
    <div class="col-lg-5 col-sm-5 relative"  >
