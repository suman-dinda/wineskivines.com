...
?> 	    
<table id="table_list" class="table data_tables table-hover data_table_low_stock not_editable">
<thead>
<tr> 
 ...
 <th class="col-qty"><?php echo translate("In stocks")?></th> 
 <th class="col-qty"><?php echo translate("Date")?></th> 
</tr>
</thead>
<tbody>  
</tbody>
