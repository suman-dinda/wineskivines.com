...
<div class="col-md-6">
 ...
 <div class="card card_medium" id="box_wrap">
	<div class="card-body">
	 ...
	 $hide_menu = array('dashboard','userprofile');
	 ?>
	 	 	 	 
	 <?php if(is_array($menu) && count($menu)>=1):?>
	 <ul class="access_role_list list-groupx pt-4">
	 <?php foreach ($menu['items'] as $val): ?>
	   <li class="list-group-itemx" style="<?php echo in_array($val['id'],$hide_menu)?"display:none;":"";?>" >	   		 
...
<div class="floating_action">
       <a href="<?php echo Yii::app()->createUrl(APP_FOLDER.'/adm/access_rights')?>" 
	   class="<?php echo ItemHtmlWrapper::cancelBtnClass()?>">
