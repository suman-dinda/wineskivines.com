<div class="row">
  ...
  <div class="card card_medium" id="box_wrap">
	...
	<div class="form-group pt-2">
	  ...
	  <p class="text-muted"><?php echo translate("This is the default order status will be use in all reportings")?></p>
	</div>
	
	<div class="form-group pt-2">
	  <label><?php echo translate("Sales order status")?></label>
	  ...
	  <p class="text-muted"><?php echo translate("This is the status consider as new sale that will deduct item stocks")?></p>
	</div>
	...
	<div class="form-group pt-2">
	  ...
	  <p class="text-muted">
	  <?php echo translate("This is the status when the order is cancel,denied or failed, the qty of items will revert back as stock")?>
	  </p>
	</div>

<div class="floating_action">
   <a href="<?php echo Yii::app()->createUrl(APP_FOLDER.'/adm/general')?>" class="<?php echo ItemHtmlWrapper::cancelBtnClass()?> ">
