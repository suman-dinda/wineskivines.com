...
<div class="card">
  ...
  <div class="row">
     ...
     <div class="col-md-6">
       ...
       <?php 
	   echo CHtml::dropDownList('inline_value', $inventory_role_id, (array)$role,array(
	     'class'=>"form-control inline_value"
	   ));
	   echo CHtml::hiddenField('inline_id',$merchant_id,array(
