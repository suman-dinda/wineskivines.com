...
<thead>
<tr> 
 <th width="70%" class="no-sort" colspan="2"><?php echo translate("Top 5 items")?></th> 
...
<table id="table_list" class="table data_tables table-hover table_sales_item not_editable">
<thead>
<tr> 
 <th width="15%" class="no-sort"><?php echo translate("Item")?></th> 
 <th width="10%" class="no-sort"><?php echo translate("Category")?></th> 
 ...
 <th width="10%" class="no-sort text-right"><?php echo translate("Current Stock") ?></th> 
</tr>
</thead>
<tbody>  
</tbody>
