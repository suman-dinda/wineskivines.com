...
<table id="table_list" class="table data_tables table-hover table_sales_addon not_editable">
<thead>
<tr> 
 <th width="25%" class="no-sort"><?php echo translate("Addon item")?></th> 
 <th width="35%" class="no-sort col-qty"><?php echo translate("Quantity sold")?></th> 
 <th width="35%" class="no-sort col-qty"><?php echo translate("Gross sales")?></th>  
</tr>
</thead>
<tbody>  
</tbody>
